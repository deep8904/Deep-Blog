# Personal-writer blog research

This redesign was informed by real independent writer and maker websites, not only visual templates.
...
- Write Framer reference — `https://write-blog.framer.website/`
- Nitro Framer reference — `https://nitro.framer.website/`
- Opus Framer reference — `https://opus-template.framer.website/`
...
The writing index is easy to find and usually simple to scan. The homepage supports the archive rather than behaving like a startup landing page. Draft State keeps a prominent Notes route and a designed zero-post state without creating demonstration content.
...
## Decisions made from the research
...
- Removed the electric-blue visual system.
- Introduced an editorial palette of parchment, charcoal, sand, and oxide red.
- Kept the bento composition, but tied every card to useful information.
- Kept the archive empty until a real post exists.
- Preserved lightweight motion and avoided animation libraries.
